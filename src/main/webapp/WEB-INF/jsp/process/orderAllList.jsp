		...
		<div id="dcMain">
			...
			<div class="mainBox"
				...
				<h3>
					...
					</label><input type="date" class="inp_name" id="startTime" style="width: 150px" /> <label
						class="label_select">-</label><input type="date" class="inp_name"
						id="endTime" style="width: 150px" /> <input type="button" value="搜索" class="inp_btn"
