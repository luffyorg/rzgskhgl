...
h1 {
	...
	background-image: url(${basePath }static/images/404.jpg);
...
<body>
	...
	<p class="link">
		<a href="${basePath }admin/index"  >返回首页</a> 
		<a onclick="location.href='javascript:history.go(-1);'" class="actionBtn">返回上一页</a>
	</p>
