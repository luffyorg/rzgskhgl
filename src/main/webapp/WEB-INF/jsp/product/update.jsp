	...
	<div id="content">
		<sf:form method="post" modelAttribute="product" id="addForm">
			<table width="800" cellspacing="0" cellPadding="0">
				...
				<tr>
					<td class="rightTd">产品编号:</td>
					<td><sf:input path="productNo" size="30" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><sf:select path="isEnable">
							<sf:option value="0">下架</sf:option>
							<sf:option value="1">上架</sf:option>
						</sf:select></td>
				</tr>

				<tr>
					<td colspan="2" class="centerTd"><input type="submit"
						value="更新产品" /><input type="reset" /></td>
				</tr>
			</table>
		</sf:form>
	</div>
