...
.productLabel,.objectLabel,.conditionLabel,
.progressLabel,.priceLabel,.warnLabel{
    width:100%;
    height:100px;
    line-height:100px;
    color: #5A74B9;
...
.productContent,.objectContent,.conditionContent,
.progressContent,.priceContent,.warnContent{
    width:100%;
    height:auto;
    line-height:80px;
    color: #353535;
...
<body>
	<div class="ProDetail_title">${product.name }</div>
        <div class="ProDetail">
            ...
            <div class="conditionContent">&nbsp;&nbsp;&nbsp;&nbsp;共和家人和国际法和家乐福四级联考高房价的概率活佛济公回复还记得发货</div>
            <div class="progressLabel">业务流程</div>
            <div class="progressContent">&nbsp;&nbsp;&nbsp;&nbsp;梵蒂冈那件的妇科病的凤凰健康货到付款价格日感觉热狗</div>
            <div class="priceLabel">产品定价</div>
            <div class="priceContent">&nbsp;&nbsp;&nbsp;&nbsp;可是地方过分的话放大镜看了很久的更好看了几个来回</div>
